class CreditCard:
    ...
    def __str__(self):
        return f"[ Credit Card Number: {self._card_number}, Expiration Date: {self._card_expiration_date}, Name: {self._card_name}, CVV: {self._card_cvv}, Balance: {self._card_balance}] "
